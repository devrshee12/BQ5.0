...
mysqli_set_charset($con,'utf8');
  ...
  $result6 = mysqli_query($con,$sql6);  
            ...
            $sql3 = "SELECT * FROM `iv_spread` WHERE  date = '$last_date1' and Time = (SELECT Time
FROM `iv_spread` ORDER BY id DESC  LIMIT 0, 1)";        
       ...
       {
       echo json_encode(array("vol_spread" => $array_all));  //json code to encrypt
       }
