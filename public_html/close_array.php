...
$array_all_m[$total_data][] = "<span >" . Round($row['bep'], 1) . "</span>";
$array_all_m[$total_data][] =  Round($diff, 1) ;
$array_all_m[$total_data][] = "<span >" . Round($row['start_iv'], 1) . "</span>";
$array_all_m[$total_data][] =  Round($row['nse_close_vol'], 1) ;
$array_all_m[$total_data][] =  Round($row['nse_close_vol2'], 1) . "</span> ";
$array_all_m[$total_data][] =  Round($row['nse_close_vol3'], 1) ;
$array_all_m[$total_data][] =  Round($row['nse_close_vol4'], 1) ;
$array_all_m[$total_data][] =  Round($row['nse_close_vol5'], 1) ;
