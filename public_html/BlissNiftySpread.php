            ...
            <div class="col-lg-6" >
                ...
                <table id="iv_index-table" class="table table-striped table-bordered">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        $sql_current = "SELECT * FROM `index_spread` where ranges > '200' and scrip = 'NIFTY' order by ranges desc";
                        $result_current = mysqli_query($con, $sql_current);
                        $num_row = mysqli_num_rows($result_current);
                        //echo $num_row;
                        if ($num_row == 0) {
                            $sql_current = "SELECT * FROM `index_spread` where ranges > '100' and scrip = 'NIFTY' order by ranges desc";
                            $result_current = mysqli_query($con, $sql_current);
                        }
