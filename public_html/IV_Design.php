...
// echo $_SESSION['plan'];
    ...
    echo "   
                                    ...
                                    <th class='col-lg-1'>Live IV </th>
                                     <th class='col-lg-1'><span >" . $quarter_pre_month . "-" . $quarter_pre['year'] . " Q IV<br> Min-Avg-Max</span></th>
                                          <th class='col-lg-1'><span >" . $quarter_month . "-" . $quarter['year'] . " Q IV<br> Min-Avg-Max</span> </th>
