...
$live_date = $row['live_date'];
            ...
            if ($average_mov >= 3) {//echo $row[1];
                $quarter_maxmin = explode(" - ", $lq_minmax_avg_iv);
                if (($yes_in - $quarter_maxmin[0]) < ($quarter_maxmin[2] - $yes_in)) {
