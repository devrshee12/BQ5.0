...
$sql_result_vol = "SELECT AVG(ATM_vol) FROM `$table_name` WHERE date > '2014-01-01' and date < '2014-12-31' and days_of_expire > 3";
...
$sql = "SELECT entry_number,date,ATM_vol,Time,days_of_expire,ROUND(delta,2),ATM,ATM_price,spot,volume from `$table_name` t1 "
        . "WHERE date > '2014-01-01' and date < '2014-12-31' and ATM_vol > 0 and ABS(delta - 0) > 0.0001 and delta < 1 and  days_of_expire > 0  ORDER BY `date` ASC";
