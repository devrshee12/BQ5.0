          ...
          // echo $table_name." ";
            ...
            $j=0;
                ...
                {// when holiday is there, single day data are not fetching as we are retrieving that from date
                    ...
                    $sql1 = "SELECT date,Round(ATM_vol,1),Time,days_of_expire,ROUND(delta,2),ATM,ATM_price,spot from `$table_name` WHERE date = '$last_date1' and ATM_vol > 0 and delta > 0.0001 and delta < 1 order by date,Time ASC ";
