    ...
    <div class="" style='border-bottom: 1px solid #DDD;' role="navigation"> <!--This navbar class use for create navigation bar From bootstramp    -->
        ...
        <div class="navbar-collapse collapse" > <!-- this is a unordered list class --> 
            <ul class="navbar-nav nav" id="main_navbar">    <!-- unordered list class-->          
                <li><a href="index.php" >Home</a></li> <!-- this is Header list Option (1)Home --> 
                <li class="dropdown dropdown-large"><a href="BlissData.php" >Analytics</a> <!-- This is Header list option(2)Option data and its class is dropdown --> 
                        ...
                        <div class="row">
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    if (isset($_SESSION['email']) && ($_SESSION['email'] == 'vineetjain495@gmail.com' || $_SESSION['email'] == 'sfalguni.v@gmail.com' || $_SESSION['email'] == 'rupak.shah99@gmail.com' || $_SESSION['email'] == 'vedipatel99@gmail.com')) {
                                        ?>
                                        <li > <a href="BlissData.php">IV Analytics: Quarterly Average  </a></li>
                                        <li  > <a href="recommend_iv_all.php">IV Analytics: Hedgers' experience</a></li>
                                        <li  > <a href="days_avg.php">IV Analytics: 60 days average</a></li>
                                        <li><a href="next_day_gap.php" >IV Analytics: Next Day Gap Difference</a></li>
                                        <li><a href="BlissVega_neutral.php" >IV Analytics: Vega Skew  </a></li>
                                        <li  > <a href="iv2_short.php">IV Analytics: Last 3 similar months </a></li>
                                        <li  > <a href="iv3_short.php">IV Analytics: Last 2 similar months </a></li>
                                        <li > <a href="huge_gap.php"> IV Analytics: Huge Gap Difference</a></li>
                                        <li > <a href="BlissIndexSpread.php"> IV Analytics: Index IV Skew</a></li>
                                        <li  > <a href="BlissData_close.php">IV Analytics: Last 5 closed & BEP IV </a></li>
                                        <li  > <a href="banknifty_butterfly.php">IV Analytics: Butterfly </a></li>
                                        <li  > <a href="BlissOI.php">IV Analytics: Index OI </a></li>
                                        <li  > <a href="get_collar.php">IV Analytics: Collar </a></li>
                                    ...
                                    <?php } elseif (isset($_SESSION['email']) && ($_SESSION['email'] == 'samir_dabhelia@yahoo.in' || $_SESSION['email'] == '2006maulik@gmail.com' || $_SESSION['email'] == 'alpeshkanadiya11@gmail.com' || $_SESSION['email'] == 'nileshghevariya@yahoo.com' || $_SESSION['email'] == 'falgunipro@blissquants.com')) {
                                        ...
                                        <li  > <a href="BlissPricing.php">IV Analytics: Pricing </a></li>       
                                        <li  > <a href="BlissData_close.php">IV Analytics: Last 5 closed & BEP IV  </a></li>
                                    ...
                                    <?php } else {
                                        ...
                                        <li > <a href="BlissData.php"> IV Analytics: Quarterly Average</a></li>
                                        <li > <a href="huge_gap.php"> IV Analytics: IV Gap Difference</a></li>
                                        <li  > <a href="BlissData2.php">IV Analytics: Last 3 similar months  </a></li>
                                        <li  > <a href="BlissData_close.php">IV Analytics: Last 5 closed & BEP IV </a></li>
                                        <li > <a href="BlissIndexSpread.php"> IV Analytics: Index Skew</a></li>

                                        <li  > <a href="Blissoi.php">IV Analytics: Nifty OI </a></li>
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    if (isset($_SESSION['email']) && ($_SESSION['email'] == 'vineetjain495@gmail.com' || $_SESSION['email'] == 'rupak.shah99@gmail.com' || $_SESSION['email'] == 'vedipatel99@gmail.com' || $_SESSION['email'] == 'shahnehalb.ns@gmail.com')) {
                                        ...
                                        <li><a href="BlissDelta_Data.php" > <span style='color:yellow'>  IV Analytics: Dashboard  </span></a></li>
                                        <li  > <a href="BlissEye.php">IV: Chart Watchlist </a></li>
                                        <li  > <a href="Watchlist.php">IV: Stock Watchlist </a></li>
                                        <li  > <a href="BlissPricing.php">IV Analytics: Pricing </a></li> 
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="BlissEarnings.php">Result Data</a></li>
                                    <li><a href="BlissEventCalendar.php">Economics Data</a></li>
                                    <li><a href="Bliss_Fii_Dii_Data.php">FII / DII Data</a></li>
                                    <li><a href="BlissIndiaVix.php">IndiaVIX / Nifty Charts</a></li>
                                    <li><a href="cboe_vix.php">IndiaVIX / CBOEVIX Charts</a></li>
                            ...
                            <li class="col-sm-3">
                                <ul>
                                    ...
                                    <li><a href="BlissOptionCalculator.php">Option Calculator</a></li>
                                    <li><a href="BlissIV_projection.php">IV Projection</a></li>
                                    <li><a href="BlissIntraday.php">Historical IV</a></li>
                                    <li><a href="BlissVol.php">IV HeatMap</a></li>
                                    <li><a  href="BlissCalc_Alpha40_final.xls">BlissCalc</a></li><!--This is BlissCalc option in Products  -->
                                    <li class="divider"></li>
                                </ul>
                            </li>
                ...
                <li ><a href="Solutions_DashBoard.php" >Solutions</a> <!-- This is Header list option(2)Option data and its class is dropdown --> 


                </li>

                <li class="dropdown dropdown-large"><a href="Bliss_Services.php">Services</a><!--This is Header list option (6)About there are use of dropdown clas  -->
                    <ul class="dropdown-menu dropdown-menu-large ">
                        <div class="row">
                            <li class="col-sm-12">
                                <ul>
                                    ...
                                    <li  > <a href="Bliss_Services.php" > Software Development </a></li>
                                    <li  > <a href="Bliss_Coaching.php" > Teaching Courses </a></li>
                                    <li > <a href="Delta_awareness_program.php" > Option Delta Hedging Awareness Program </a></li>
                                    <li > <a href="BlissKB.php" > Knowledge Base </a></li>
                                    <li class="divider"></li>
...
//alert(curr_link);
    ...
    <div class="modal fade" id="invite-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-header">
                <h3 class='text-center'>BlissQuants awareness Program</h3>
            </div>
            <div class="modal-dialog">
                ...
                <br> 
                     <P> OR </p>-->
                    <form name="invite" action="invite_connect.php" data-toggle="validator" role="form" method="post" class="form-signin text-center" >
                        <div class="row">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-xs-6 col-sm-6 col-lg-6 form-group"> 
                                <input  class="form-control"   name="college"  placeholder="College / School / Company / Institute" data-error="please fill the name of college" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-lg-12  form-group">  
                                <input type="textarea" class="form-control" name="message" id="inputEmail" placeholder="Message"  >
                            </div>
                        </div> 
                        <br>
                        <button class="btn btn-lg btn-block" type="submit"  >
