...
<div class="row wrap">    
            ...
            <div class="row title_all" >
                <div class="col-lg-8" >
                    <ul class="nav nav-tabs" style="border:none">  
                        <li  > <a href="next_day_gap" onmouseenter="show_description()" onmouseleave="hide_description()">IV Data</a></li> 



                        <li  > <a href="next_day_gap_short"  >Short</a></li> 
                        <li  > <a href="next_day_gap_long"  >Long</a></li> 
                        <h3>IV Analytics: Next Day Gap Difference</h3> 
                    </ul> 
                </div>
    ...
    ?>
                        ...
                        <li >
                            <button class="btn btn-default control_color_1" id="add_watch" onclick="add_to_watchlist('yes')" >  <i class="fa fa-plus-square" aria-hidden="true"></i></button>
                        </li>
                        <li >
                            <button class="btn btn-default control_color_1" id="clear_watch" onclick="add_to_watchlist('no')" ><i class="fa fa-minus-square" aria-hidden="true"></i></button>
                        </li>
