...
<link rel="stylesheet" type="text/css" href="bootstrap-3.3.4-dist/css/BlissData.css">    
    ...
    <body  onload="range_sel('watchlist_connect.php')">   <!-- by default load 1 day data -->  
      
    <?php   include("IV_Design_internal.php"); ?>
    </body>
</html>
 <script>
        document.getElementById("iv_title").innerHTML= "Watchlist";
        </script>