...
<link rel="stylesheet" type="text/css" href="bootstrap-3.3.4-dist/css/BlissData.css">    
    ...
    <body  onload="range_sel('low_priced_connect.php')">   <!-- by default load 1 day data -->  
    <?php   include("IV_Design.php"); ?>
    </body>
</html>
 <script>
        document.getElementById("iv_title").innerHTML= "Low IV Analytics – List of securities which are running at low Implied Volatility";
        </script>