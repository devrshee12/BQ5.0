...
{    
 ...
 if(document.getElementById("range_vq").value === "range")
 {
     $(function()                                                                   //function for date-pick
     {
         ...
         $( "#day1_vq" ).datepicker({ dateFormat: 'd M yy',yearRange: "2008:2016" , changeYear: true,   background: '#FFFFFF', dayNamesMin: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],  });
     }); 
    $(function()                                                                    //function for date-pick
     {
         $( "#day2_vq" ).datepicker('destroy');
         $( "#day2_vq" ).datepicker({ dateFormat: 'd M yy',yearRange: "2008:2016" , changeYear: true,   background: '#FFFFFF', dayNamesMin: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],  });
     }); 
...
var chart = AmCharts.makeChart("chartdiv2", {
    ...
    "graphs": [{
     ...
     //"valueField": "ud_value",
        ...
        // "data" :[{title: "India Vix" , color: "#0080FF",valueAxis: "v1",},{title: "Nifty", color: "#FFFFFF"},{title: ">10% Up Down", color: "#84C225"}],         
         verticalGap : 0,
...
function generateChartData2() {
  ...
  //  alert(date2);
    ...
    $.post('connect/cboe_vix_connect.php',{ date1:date2 }, function(result)                       // retrive values from india vix table
    {         
      //  alert(result);
        var str2 = 'No Data';
   ...
   var chartData = [];
    ...
    for (var i = 0; i < parseInt(arr_data.b); i++) {
      ...
      if(nft_change > 10)
     {
         nft_balloon = "<b><span style='color:#005900'>CBOE VIX</span> <br>"+Math.abs(arr_data.a[j+2]).toFixed(1) + "<br> <span style='color:#005900'>" + Math.abs(nft_p_close - nft_close).toFixed(2) + "  Point Up</span></b>";
     line_color = "#ffffff";
     ud_value = arr_data.a[j+2];
        }    
   else if(nft_change < (-10))
     {
         nft_balloon ="<b><span style='color:#005900'>CBOE VIX</span> <br>"+ Math.abs(arr_data.a[j+2]).toFixed(1)+ "<br> <span style='color:ff0000'>" + Math.abs(nft_p_close - nft_close).toFixed(2) + "  Point Down </span></b>";
     line_color = "#ffffff";
      ud_value = arr_data.a[j+2];
    }
     else
     {
         nft_balloon ="<b><span style='color:#005900'>CBOE VIX</span> <br>"+Math.abs(arr_data.a[j+2]).toFixed(1)+"</b>";
     }    
