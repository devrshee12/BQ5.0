...
var ar_data;
function add_to_watchlist_dash()
{
    search = document.getElementById('search1').value;

    if ($("#watch_check").prop('checked') == true) {
        watch_check = "yes";
        document.getElementById('add_watch_dash').innerHTML = "added";
    } else {
        
        watch_check = "No";
        document.getElementById('add_watch_dash').innerHTML = "add";
        //alert("fx");
    }
...
function show_dashboard(eq)
{

    //
    $('#dashboard').show();
   
    $('#dashboard').load("dash_div.php?search1="+eq);
